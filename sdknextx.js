...
(()=>{Object.defineProperty(window,"$http",{get:()=>{function P(r,t=10){let e=null;return(...l)=>{e===null&&(r(...l),e=setTimeout(()=>{e=null},t))}}function i(r,t=10){let e;return function(...l){clearTimeout(e),e=setTimeout(()=>{r(...l)},t)}}function a(r,t){return typeof r=="function"&&r(t)}function o(r,t){return new URL(r,t||document.baseURI).toString()}function s(r,t,e,l){if(!navigator.onLine)return a(l,{result:!1,code:400,message:"No internet connection"});fetch(r,{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:t,payLoad:e||{}})}).then(d=>{if(!d||!d.ok)throw new Error(d.statusText);return d.json()}).then(d=>{a(l,d)}).catch(d=>a(l,{result:!1,code:400,message:d.message||""}))}function g(r,t){if(!navigator.onLine)return a(t,{result:!1,code:400,message:"No internet connection"});fetch(r).then(e=>{if(!e.ok)throw new Error(e.statusText);return e.json()}).then(e=>{a(t,e)}).catch(e=>{a(t,{result:!1,code:400,message:e.message||""})})}function v(r){if(!r)return"";let t=r?.filterRules??[],e=r?.type??"and";if(e&&t.length>0){let u=t.map(c=>v(c)).filter(c=>c);return u.length>0?` ( ${u.join(` ${e} `)} ) `:""}let l=r?.field?.trim()??"",d=r?.op??"=",n=r?.value??"";return l?(n.startsWith("{{")&&n.endsWith("}}")?n=n.slice(2,-2):typeof n=="string"&&(n=n.trim(),n=`s'${n}'`),`${l} ${d} ${n}`):""}function p(r){if(!r)return"";let t=r?.id??"",e=r?.select??{},l=r?.where??{},d=r?.group??[],n=r?.order??{},u=r?.limit??100,c=r?.start??0,q=v(l),I="*";e&&(I=Object.keys(e).map(f=>`${e[f]} as ${f}`).join(","));let y=d.join(","),$=Object.keys(n).map(f=>`${f} ${n[f]}`).join(",");return{id:t,select:I,where:q,group:y,order:$,limit:u,start:c}}var h=(r=>({keepOnline:i(function(t){let e=o("/user/keep-online",r);s(e,"",{},t)},500),checkAuth:i(function(t){let e=o("/user/check-token-live",r);s(e,"",{},t)},500),login:i(function(t,e){let l=o("/user/login",r);s(l,"users/login",t,e)},500),generateQrcode:i(function(t){let e=o("/user/generate-qrcode",r);s(e,"users/qrcode/generate-qrcode",{},t)},200),checkQrcode:i(function(t,e){let l=o("/user/check-qrcode",r);s(l,"users/qrcode/check-qrcode",t,e)}),loginQrcode:i(function(t,e){let l=o("/user/login-qrcode",r);s(l,"users/qrcode/login-qrcode",t,e)}),register:i(function(t,e){let l=o("/user/register",r);s(l,"users/register",t,e)},500),resendCode:i(function(t,e){let l=o("/user/resend-code",r);s(l,"users/resend-code",t,e)}),verifyCode:i(function(t,e){let l=o("/user/register-verify-code",r);s(l,"users/register-verify-code",t,e)}),forgotPasswordRequest:i(function(t,e){let l=o("/user/forgot-password",r);s(l,"users/forgot-password",t,e)}),forgotPasswordCheckCode:i(function(t,e){let l=o("/user/forgot-password-check-code",r);s(l,"users/forgot-password-check-code",t,e)}),forgotPasswordSetNewPassword:i(function(t,e){let l=o("/user/forgot-password-reset",r);s(l,"users/forgot-password-reset",t,e)}),profile:i(function(t){let e=o("/user/profile",r);s(e,"users/profile",{},t)}),updateProfile:i(function(t,e){let l=o("/user/update-profile",r);s(l,"users/update-profile",t,e)}),changePassword:i(function(t,e){let l=o("/user/change-password",r);s(l,"users/change-password",t,e)}),logout:i(function(t){let e=o("/user/logout",r);s(e,"users/logout",{},t)})}))("https://account.demo.pitoall.com"),m=(r=>({create:i(function(t,e,l,d){let n=o("/docs/create",r),u="docs/create";l={...l,gid:t,type:e},s(n,u,l,d)},100),update:i(function(t,e,l,d){let n=o("/docs/update",r);s(n,"docs/update",{gid:t,id:e,content:l},d)},100),delete:i(function(t,e,l,d){let n=o("/docs/delete",r);s(n,"docs/delete",{gid:t,id:e,content:l},d)},100),list:i(function(t,e,l){let d=o("/docs/list",r),n="docs/list",u=p(e);u.id=t,s(d,n,u,l)},500)}))("https://groups.demo.pitoall.com"),w=(r=>({create:i(function(t,e){let l=o("/groups/create",r);s(l,"groups/create",t,e)},100),update:i(function(t,e,l){let d=o("/groups/update",r);s(d,"groups/update",{id:t,content:e},l)},100),taxCode:i(function(t,e){let l=o("https://api.vietqr.io/v2/business/"+t);g(l,d=>{d&&d.code=="00"?a(e,{result:!0,code:200,data:d.data}):a(e,{result:!1,code:400,message:""})})}),banks:i(function(t){let e=o("https://api.vietqr.io/v2/banks");g(e,l=>{l&&l.code=="00"?a(t,{result:!0,code:200,data:{data:l.data,total:l.data.length}}):a(t,{result:!1,code:400,message:""})})}),list:i(function(t,e){let l=o("/groups/list",r),d="groups/list",n=p(t);s(l,d,n,e)},500),docs:m}))("https://groups.demo.pitoall.com"),k=(r=>({address_update:function(t,e){let l=o("/address/update",r);s(l,"address/update",t,e)},address_list:i(function(t,e){let l=o("/address/list",r),d="address/list",n=p(t);s(l,d,n,e)},500),geo_address:i(function(t,e){let l=o("/address/geo_autocomplete",r);s(l,"address/geo_autocomplete",t,e)}),geo_detail:i(function(t,e){let l=o("/address/geo_detail",r);s(l,"address/geo_detail",t,e)})}))("https://groups.demo.pitoall.com");return{account:h,business:w,cates:k}}});})();

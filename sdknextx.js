...
`)),document.adoptedStyleSheets=[...document.adoptedStyleSheets,e,...l],Object.keys(S).forEach(r=>{let o="tfl-"+r+"-0",v="tfl-"+r+"-1";if(localStorage.getItem(o))try{S[r][0]=new Set(JSON.parse(localStorage.getItem(o)))}catch{localStorage.removeItem(o)}if(localStorage.getItem(v))try{S[r][1]=new Set(JSON.parse(localStorage.getItem(v)))}catch{localStorage.removeItem(v)}}),Object.keys(S).forEach(r=>{let o=[...S[r][0]],v=[...S[r][1]];C(r,0,o),C(r,1,v)});let t=W(),i=$(document);N(i),P(r=>{N(r),t(1e3)})},renCssFromArray:O}};(()=>{Object.defineProperty(window,"tjs",{value:{...R,...le(R),...ne,...ie(R),...oe(R),cssFun:ae},writable:!1,configurable:!1,enumerable:!1}),["add","tags","state","derive","hydrate","calc","reactive","stateFields","raw","list","replace","addHtmToElement","domToJs","define","Await","MessageBoard","topMostZIndex","FloatingWindow","loadEventDom","renCssFromArray"].forEach(T=>{Object.defineProperty(window,"$"+T,{value:R[T],writable:!1,configurable:!1,enumerable:!1})}),addEventListener("tjs-load",function(){let I=R.addHtmToElement("document.body",document.body.innerHTML).join(`

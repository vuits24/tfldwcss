...
(()=>{Object.defineProperty(window,"$http",{get:()=>(h=>{function S(e,t=10){let l=null;return(...r)=>{l===null&&(e(...r),l=setTimeout(()=>{l=null},t))}}function o(e,t=10){let l;return function(...r){clearTimeout(l),l=setTimeout(()=>{e(...r)},t)}}function a(e,t){return typeof e=="function"&&e(t)}function n(e){return new URL(e,h||document.baseURI).toString()}async function u(e,t,l,r){if(!navigator.onLine)return a(r,{result:!1,code:400,message:"No internet connection"});try{let s=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:t,payLoad:l||{}})});if(!s||!s.ok)return a(r,{result:!1,code:400,message:s.statusText});let i=await s.json();a(r,i);return}catch(s){return a(r,{result:!1,code:400,message:s.message||""})}}async function g(e,t){if(!navigator.onLine)return a(t,{result:!1,code:400,message:"No internet connection"});let l=await fetch(e);if(!l.ok)return a(t,{result:!1,code:400,message:l.statusText});l.then(r=>r.json()).then(r=>{a(t,r)}).catch(r=>{a(t,{result:!1,code:400,message:r})})}function p(e){if(!e)return"";let t=e?.filterRules??[],l=e?.type??"and";if(l&&t.length>0){let f=t.map(d=>p(d)).filter(d=>d);return f.length>0?` ( ${f.join(` ${l} `)} ) `:""}let r=e?.field?.trim()??"",s=e?.op??"=",i=e?.value??"";return r?(i.startsWith("{{")&&i.endsWith("}}")?i=i.slice(2,-2):typeof i=="string"&&(i=i.trim(),i=`'${i}'`),`${r} ${s} ${i}`):""}function m(e){if(!e)return"";let t=e?.select??{},l=e?.where??{},r=e?.group??[],s=e?.order??{},i=e?.limit??100,f=e?.start??0,d=p(l),v="*";t&&(v=Object.keys(t).map(c=>`${t[c]} as ${c}`).join(","));let $=r.join(","),_=Object.keys(s).map(c=>`${c} ${s[c]}`).join(",");return{select:v,where:d,group:$,order:_,limit:i,start:f}}var y={login:o(function(e,t,l){let r=n("/user/login");u(r,"users/login",{username:e,password:t},l)},500)},I={createOrUpdate:o(function(e,t){let l=n("/organize/create_update");u(l,"organize/create",e,t)},100),taxCode:o(function(e,t){let l=n("https://api.vietqr.io/v2/business/"+e);g(l,r=>{r&&r.code=="00"?a(t,{result:!0,code:200,data:r.data}):a(t,{result:!1,code:400,message:""})})}),banks:o(function(e){let t=n("https://api.vietqr.io/v2/banks");g(t,l=>{l&&l.code=="00"?a(e,{result:!0,code:200,data:{data:l.data,total:l.data.length}}):a(e,{result:!1,code:400,message:""})})}),list:o(function(e,t){let l=n("/organize/list"),r="organize/list",s=m(e);u(l,r,s,t)},500)},w={address_update:function(e,t){let l=n("/address/update");u(l,"address/update",e,t)},address_list:o(function(e,t){let l=n("/address/list"),r="address/list",s=m(e);u(l,r,s,t)},500),geo_address:o(function(e,t){let l=n("/address/geo_autocomplete");u(l,"address/geo_autocomplete",e,t)}),geo_detail:o(function(e,t){let l=n("/address/geo_detail");u(l,"address/geo_detail",e,t)})};return{account:y,business:I,cates:w}})("https://api.demo.pitoall.com")});})();

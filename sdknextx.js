...
(()=>{Object.defineProperty(window,"$http",{get:()=>(v=>{function S(e,t=10){let l=null;return(...r)=>{l===null&&(e(...r),l=setTimeout(()=>{l=null},t))}}function s(e,t=10){let l;return function(...r){clearTimeout(l),l=setTimeout(()=>{e(...r)},t)}}function a(e,t){return typeof e=="function"&&e(t)}function i(e){return new URL(e,v||document.baseURI).toString()}async function u(e,t,l,r){if(!navigator.onLine)return a(r,{result:!1,code:400,message:"No internet connection"});let n=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:t,payLoad:l})});if(!n||!n.ok)return a(r,{result:!1,code:400,message:n.statusText});n.json().then(o=>{a(r,o)}).catch(o=>{a(r,{result:!1,code:400,message:o})})}async function f(e,t){if(!navigator.onLine)return a(t,{result:!1,code:400,message:"No internet connection"});let l=await fetch(e);if(!l.ok)return a(t,{result:!1,code:400,message:l.statusText});l.then(r=>r.json()).then(r=>{a(t,r)}).catch(r=>{a(t,{result:!1,code:400,message:r})})}function p(e){if(!e)return"";let t=e?.filterRules??[],l=e?.type??"and";if(l&&t.length>0)return" ( "+t.map(c=>p(c)).join(` ${l} `)+" ) ";let r=e?.field?.trim()??"",n=e?.op??"=",o=e?.value??"";return r?`${r} ${n} ${o}`:""}function m(e){if(!e)return"";let t=e?.select??{},l=e?.where??{},r=e?.group??[],n=e?.order??{},o=e?.limit??100,c=e?.start??0,w=p(l),g="*";t&&(g=Object.keys(t).map(d=>`${t[d]} as ${d}`).join(","));let _=r.join(","),$=Object.keys(n).map(d=>`${d} ${n[d]}`).join(",");return{select:g,where:w,group:_,order:$,limit:o,start:c}}var h={login:s(function(e,t,l){let r=i("/user/login");u(r,"users/login",{username:e,password:t},l)},500)},I={createOrUpdate:s(function(e,t){let l=i("/organize/create_update");u(l,"organize/create",e,t)},100),taxCode:s(function(e,t){let l=i("https://api.vietqr.io/v2/business/"+e);f(l,t)}),banks:s(function(e){let t=i("https://api.vietqr.io/v2/banks");f(t,e)}),list:s(function(e,t){let l=i("/organize/list"),r="organize/list",n=m(e);u(l,r,n,t)},500)},y={address_update:function(e,t){let l=i("/address/update");u(l,"address/update",e,t)},address_list:s(function(e,t){let l=i("/address/list");u(l,"address/list",e,t)},500),geo_address:s(function(e,t){let l=i("/address/geo_autocomplete");u(l,"address/geo_autocomplete",e,t)}),geo_detail:s(function(e,t){let l=i("/address/geo_detail");u(l,"address/geo_detail",e,t)})};return{account:h,business:I,cates:y}})("https://api.demo.pitoall.com")});})();
(function() {
    const __exports = {};
    let script_src;

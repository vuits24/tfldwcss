...
(()=>{Object.defineProperty(window,"$http",{get:()=>{function k(d,t=10){let e=null;return(...l)=>{e===null&&(d(...l),e=setTimeout(()=>{e=null},t))}}function o(d,t=10){let e;return function(...l){clearTimeout(e),e=setTimeout(()=>{d(...l)},t)}}function u(d,t){return typeof d=="function"&&d(t)}function s(d,t){return new URL(d,t||document.baseURI).toString()}function i(d,t,e,l){if(!navigator.onLine)return u(l,{result:!1,code:400,message:"No internet connection"});fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:t,payLoad:e||{}})}).then(r=>{if(!r||!r.ok)throw new Error(r.statusText);return r.json()}).then(r=>{u(l,r)}).catch(r=>u(l,{result:!1,code:400,message:r.message||""}))}function g(d,t){if(!navigator.onLine)return u(t,{result:!1,code:400,message:"No internet connection"});fetch(d).then(e=>{if(!e.ok)throw new Error(e.statusText);return e.json()}).then(e=>{u(t,e)}).catch(e=>{u(t,{result:!1,code:400,message:e.message||""})})}function v(d){if(!d)return"";let t=d?.filterRules??[],e=d?.type??"and";if(e&&t.length>0){let a=t.map(c=>v(c)).filter(c=>c);return a.length>0?` ( ${a.join(` ${e} `)} ) `:""}let l=d?.field?.trim()??"",r=d?.op??"=",n=d?.value??"";return l?(n.startsWith("{{")&&n.endsWith("}}")?n=n.slice(2,-2):typeof n=="string"&&(n=n.trim(),n=`'${n}'`),`${l} ${r} ${n}`):""}function p(d){if(!d)return"";let t=d?.select??{},e=d?.where??{},l=d?.group??[],r=d?.order??{},n=d?.limit??100,a=d?.start??0,c=v(e),I="*";t&&(I=Object.keys(t).map(f=>`${t[f]} as ${f}`).join(","));let q=l.join(","),$=Object.keys(r).map(f=>`${f} ${r[f]}`).join(",");return{select:I,where:c,group:q,order:$,limit:n,start:a}}var h=(d=>({login:o(function(t,e,l){let r=s("/user/login",d);i(r,"users/login",{username:t,password:e},l)},500),generateQrcode:o(function(t,e){let l=s("/user/generate-qrcode");i(l,"users/generate-qrcode",t,e)},200),checkQrcode:o(function(t,e){let l=s("/user/check-qrcode");i(l,"users/check-qrcode",t,e)}),loginQrcode:o(function(t,e){let l=s("/user/login-qrcode");i(l,"users/login-qrcode",t,e)}),register:o(function(t,e){let l=s("/user/register");i(l,"users/register",t,e)},500),resendCode:o(function(t,e){let l=s("/user/resend-code");i(l,"users/resend-code",t,e)}),verifyCode:o(function(t,e){let l=s("/user/verify-code");i(l,"users/verify-code",t,e)}),forgotPassword:o(function(t,e){let l=s("/user/forgot-password");i(l,"users/forgot-password",t,e)}),setNewPassword:o(function(t,e){let l=s("/user/set-new-password");i(l,"users/set-new-password",t,e)}),profile:o(function(t){let e=s("/user/profile");i(e,"users/profile",{},t)}),updateProfile:o(function(t,e){let l=s("/user/update-profile");i(l,"users/update-profile",t,e)}),changePassword:o(function(t,e){let l=s("/user/change-password");i(l,"users/change-password",t,e)}),logout:o(function(t){let e=s("/user/logout");i(e,"users/logout",{},t)})}))("https://account.demo.pitoall.com"),m=(d=>({create:o(function(t,e,l,r){let n=s("/docs/create",d),a="docs/create";l={...l,gid:t,type:e},i(n,a,l,r)},100),update:o(function(t,e,l){let r=s("/docs/update",d);i(r,"docs/update",{id:t,content:e},l)},100),delete:o(function(t,e,l){let r=s("/docs/delete",d);i(r,"docs/delete",{id:t,content:e},l)},100),list:o(function(t,e){let l=s("/docs/list",d),r="docs/list",n=p(t);i(l,r,n,e)},500)}))("https://groups.demo.pitoall.com"),w=(d=>({create:o(function(t,e){let l=s("/groups/create",d);i(l,"groups/create",t,e)},100),update:o(function(t,e,l){let r=s("/groups/update",d);i(r,"groups/update",{id:t,content:e},l)},100),taxCode:o(function(t,e){let l=s("https://api.vietqr.io/v2/business/"+t);g(l,r=>{r&&r.code=="00"?u(e,{result:!0,code:200,data:r.data}):u(e,{result:!1,code:400,message:""})})}),banks:o(function(t){let e=s("https://api.vietqr.io/v2/banks");g(e,l=>{l&&l.code=="00"?u(t,{result:!0,code:200,data:{data:l.data,total:l.data.length}}):u(t,{result:!1,code:400,message:""})})}),list:o(function(t,e){let l=s("/groups/list",d),r="groups/list",n=p(t);i(l,r,n,e)},500),docs:m}))("https://groups.demo.pitoall.com"),y=(d=>({address_update:function(t,e){let l=s("/address/update",d);i(l,"address/update",t,e)},address_list:o(function(t,e){let l=s("/address/list",d),r="address/list",n=p(t);i(l,r,n,e)},500),geo_address:o(function(t,e){let l=s("/address/geo_autocomplete",d);i(l,"address/geo_autocomplete",t,e)}),geo_detail:o(function(t,e){let l=s("/address/geo_detail",d);i(l,"address/geo_detail",t,e)})}))("https://groups.demo.pitoall.com");return{account:h,business:w,cates:y}}});})();

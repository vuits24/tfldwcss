...
(()=>{Object.defineProperty(window,"$http",{get:()=>(v=>{function S(e,l=10){let t=null;return(...r)=>{t===null&&(e(...r),t=setTimeout(()=>{t=null},l))}}function o(e,l=10){let t;return function(...r){clearTimeout(t),t=setTimeout(()=>{e(...r)},l)}}function s(e,l){return typeof e=="function"&&e(l)}function a(e){return new URL(e,v||document.baseURI).toString()}function u(e,l,t,r){if(!navigator.onLine)return s(r,{result:!1,code:400,message:"No internet connection"});fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:l,payLoad:t||{}})}).then(n=>{if(!n||!n.ok)throw new Error(n.statusText);return n.json()}).then(n=>{s(r,n)}).catch(n=>s(r,{result:!1,code:400,message:n.message||""}))}function g(e,l){if(!navigator.onLine)return s(l,{result:!1,code:400,message:"No internet connection"});fetch(e).then(t=>{if(!t.ok)throw new Error(t.statusText);return t.json()}).then(t=>{s(l,t)}).catch(t=>{s(l,{result:!1,code:400,message:t.message||""})})}function p(e){if(!e)return"";let l=e?.filterRules??[],t=e?.type??"and";if(t&&l.length>0){let f=l.map(d=>p(d)).filter(d=>d);return f.length>0?` ( ${f.join(` ${t} `)} ) `:""}let r=e?.field?.trim()??"",n=e?.op??"=",i=e?.value??"";return r?(i.startsWith("{{")&&i.endsWith("}}")?i=i.slice(2,-2):typeof i=="string"&&(i=i.trim(),i=`'${i}'`),`${r} ${n} ${i}`):""}function h(e){if(!e)return"";let l=e?.select??{},t=e?.where??{},r=e?.group??[],n=e?.order??{},i=e?.limit??100,f=e?.start??0,d=p(t),m="*";l&&(m=Object.keys(l).map(c=>`${l[c]} as ${c}`).join(","));let $=r.join(","),_=Object.keys(n).map(c=>`${c} ${n[c]}`).join(",");return{select:m,where:d,group:$,order:_,limit:i,start:f}}var I={login:o(function(e,l,t){let r=a("/user/login");u(r,"users/login",{username:e,password:l},t)},500)},w={createOrUpdate:o(function(e,l){let t=a("/organize/create_update");u(t,"organize/create",e,l)},100),taxCode:o(function(e,l){let t=a("https://api.vietqr.io/v2/business/"+e);g(t,r=>{r&&r.code=="00"?s(l,{result:!0,code:200,data:r.data}):s(l,{result:!1,code:400,message:""})})}),banks:o(function(e){let l=a("https://api.vietqr.io/v2/banks");g(l,t=>{t&&t.code=="00"?s(e,{result:!0,code:200,data:{data:t.data,total:t.data.length}}):s(e,{result:!1,code:400,message:""})})}),list:o(function(e,l){let t=a("/organize/list"),r="organize/list",n=h(e);u(t,r,n,l)},500)},y={address_update:function(e,l){let t=a("/address/update");u(t,"address/update",e,l)},address_list:o(function(e,l){let t=a("/address/list"),r="address/list",n=h(e);u(t,r,n,l)},500),geo_address:o(function(e,l){let t=a("/address/geo_autocomplete");u(t,"address/geo_autocomplete",e,l)}),geo_detail:o(function(e,l){let t=a("/address/geo_detail");u(t,"address/geo_detail",e,l)})};return{account:I,business:w,cates:y}})("https://api.demo.pitoall.com")});})();

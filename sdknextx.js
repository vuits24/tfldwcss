...
(()=>{Object.defineProperty(window,"$http",{get:()=>{function S(r,t=10){let e=null;return(...l)=>{e===null&&(r(...l),e=setTimeout(()=>{e=null},t))}}function s(r,t=10){let e;return function(...l){clearTimeout(e),e=setTimeout(()=>{r(...l)},t)}}function a(r,t){return typeof r=="function"&&r(t)}function i(r,t){return new URL(r,t||document.baseURI).toString()}function n(r,t,e,l){if(!navigator.onLine)return a(l,{result:!1,code:400,message:"No internet connection"});fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:t,payLoad:e||{}})}).then(d=>{if(!d||!d.ok)throw new Error(d.statusText);return d.json()}).then(d=>{a(l,d)}).catch(d=>a(l,{result:!1,code:400,message:d.message||""}))}function g(r,t){if(!navigator.onLine)return a(t,{result:!1,code:400,message:"No internet connection"});fetch(r).then(e=>{if(!e.ok)throw new Error(e.statusText);return e.json()}).then(e=>{a(t,e)}).catch(e=>{a(t,{result:!1,code:400,message:e.message||""})})}function v(r){if(!r)return"";let t=r?.filterRules??[],e=r?.type??"and";if(e&&t.length>0){let u=t.map(c=>v(c)).filter(c=>c);return u.length>0?` ( ${u.join(` ${e} `)} ) `:""}let l=r?.field?.trim()??"",d=r?.op??"=",o=r?.value??"";return l?(o.startsWith("{{")&&o.endsWith("}}")?o=o.slice(2,-2):typeof o=="string"&&(o=o.trim(),o=`s'${o}'`),`${l} ${d} ${o}`):""}function p(r){if(!r)return"";let t=r?.id??"",e=r?.select??{},l=r?.where??{},d=r?.group??[],o=r?.order??{},u=r?.limit??100,c=r?.start??0,q=v(l),I="*";e&&(I=Object.keys(e).map(f=>`${e[f]} as ${f}`).join(","));let $=d.join(","),k=Object.keys(o).map(f=>`${f} ${o[f]}`).join(",");return{id:t,select:I,where:q,group:$,order:k,limit:u,start:c}}var h=(r=>({login:s(function(t,e){let l=i("/user/login",r);n(l,"users/login",t,e)},500),generateQrcode:s(function(t){let e=i("/user/generate-qrcode",r);n(e,"users/generate-qrcode",{},t)},200),checkQrcode:s(function(t,e){let l=i("/user/check-qrcode",r);n(l,"users/check-qrcode",t,e)}),loginQrcode:s(function(t,e){let l=i("/user/login-qrcode",r);n(l,"users/login-qrcode",t,e)}),register:s(function(t,e){let l=i("/user/register",r);n(l,"users/register",t,e)},500),resendCode:s(function(t,e){let l=i("/user/resend-code",r);n(l,"users/resend-code",t,e)}),verifyCode:s(function(t,e){let l=i("/user/verify-code",r);n(l,"users/verify-code",t,e)}),forgotPassword:s(function(t,e){let l=i("/user/forgot-password",r);n(l,"users/forgot-password",t,e)}),setNewPassword:s(function(t,e){let l=i("/user/set-new-password",r);n(l,"users/set-new-password",t,e)}),profile:s(function(t){let e=i("/user/profile",r);n(e,"users/profile",{},t)}),updateProfile:s(function(t,e){let l=i("/user/update-profile",r);n(l,"users/update-profile",t,e)}),changePassword:s(function(t,e){let l=i("/user/change-password",r);n(l,"users/change-password",t,e)}),logout:s(function(t){let e=i("/user/logout",r);n(e,"users/logout",{},t)})}))("https://account.demo.pitoall.com"),m=(r=>({create:s(function(t,e,l,d){let o=i("/docs/create",r),u="docs/create";l={...l,gid:t,type:e},n(o,u,l,d)},100),update:s(function(t,e,l,d){let o=i("/docs/update",r);n(o,"docs/update",{gid:t,id:e,content:l},d)},100),delete:s(function(t,e,l,d){let o=i("/docs/delete",r);n(o,"docs/delete",{gid:t,id:e,content:l},d)},100),list:s(function(t,e,l){let d=i("/docs/list",r),o="docs/list",u=p(e);u.id=t,n(d,o,u,l)},500)}))("https://groups.demo.pitoall.com"),w=(r=>({create:s(function(t,e){let l=i("/groups/create",r);n(l,"groups/create",t,e)},100),update:s(function(t,e,l){let d=i("/groups/update",r);n(d,"groups/update",{id:t,content:e},l)},100),taxCode:s(function(t,e){let l=i("https://api.vietqr.io/v2/business/"+t);g(l,d=>{d&&d.code=="00"?a(e,{result:!0,code:200,data:d.data}):a(e,{result:!1,code:400,message:""})})}),banks:s(function(t){let e=i("https://api.vietqr.io/v2/banks");g(e,l=>{l&&l.code=="00"?a(t,{result:!0,code:200,data:{data:l.data,total:l.data.length}}):a(t,{result:!1,code:400,message:""})})}),list:s(function(t,e){let l=i("/groups/list",r),d="groups/list",o=p(t);n(l,d,o,e)},500),docs:m}))("https://groups.demo.pitoall.com"),y=(r=>({address_update:function(t,e){let l=i("/address/update",r);n(l,"address/update",t,e)},address_list:s(function(t,e){let l=i("/address/list",r),d="address/list",o=p(t);n(l,d,o,e)},500),geo_address:s(function(t,e){let l=i("/address/geo_autocomplete",r);n(l,"address/geo_autocomplete",t,e)}),geo_detail:s(function(t,e){let l=i("/address/geo_detail",r);n(l,"address/geo_detail",t,e)})}))("https://groups.demo.pitoall.com");return{account:h,business:w,cates:y}}});})();

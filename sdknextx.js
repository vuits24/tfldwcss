...
(()=>{Object.defineProperty(window,"$http2",{get:()=>(m=>{function S(e,t=10){let r=null;return(...l)=>{r===null&&(e(...l),r=setTimeout(()=>{r=null},t))}}function s(e,t=10){let r;return function(...l){clearTimeout(r),r=setTimeout(()=>{e(...l)},t)}}function a(e,t){return typeof e=="function"&&e(t)}function i(e){return new URL(e,m||document.baseURI).toString()}async function o(e,t,r,l){if(!navigator.onLine)return a(l,{result:!1,code:400,message:"No internet connection"});try{let n=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:t,payLoad:r||{}})});if(!n||!n.ok)return a(l,{result:!1,code:400,message:n.statusText});let u=await n.json();a(l,u);return}catch(n){return a(l,{result:!1,code:400,message:n.message||""})}}async function f(e,t){if(!navigator.onLine)return a(t,{result:!1,code:400,message:"No internet connection"});let r=await fetch(e);if(!r.ok)return a(t,{result:!1,code:400,message:r.statusText});r.then(l=>l.json()).then(l=>{a(t,l)}).catch(l=>{a(t,{result:!1,code:400,message:l})})}function p(e){if(!e)return"";let t=e?.filterRules??[],r=e?.type??"and";if(r&&t.length>0)return" ( "+t.map(c=>p(c)).join(` ${r} `)+" ) ";let l=e?.field?.trim()??"",n=e?.op??"=",u=e?.value??"";return l?`${l} ${n} ${u}`:""}function v(e){if(!e)return"";let t=e?.select??{},r=e?.where??{},l=e?.group??[],n=e?.order??{},u=e?.limit??100,c=e?.start??0,w=p(r),g="*";t&&(g=Object.keys(t).map(d=>`${t[d]} as ${d}`).join(","));let _=l.join(","),$=Object.keys(n).map(d=>`${d} ${n[d]}`).join(",");return{select:g,where:w,group:_,order:$,limit:u,start:c}}var h={login:s(function(e,t,r){let l=i("/user/login");o(l,"users/login",{username:e,password:t},r)},500)},I={createOrUpdate:s(function(e,t){let r=i("/organize/create_update");o(r,"organize/create",e,t)},100),taxCode:s(function(e,t){let r=i("https://api.vietqr.io/v2/business/"+e);f(r,t)}),banks:s(function(e){let t=i("https://api.vietqr.io/v2/banks");f(t,e)}),list:s(function(e,t){let r=i("/organize/list"),l="organize/list",n=v(e);o(r,l,n,t)},500)},y={address_update:function(e,t){let r=i("/address/update");o(r,"address/update",e,t)},address_list:s(function(e,t){let r=i("/address/list");o(r,"address/list",e,t)},500),geo_address:s(function(e,t){let r=i("/address/geo_autocomplete");o(r,"address/geo_autocomplete",e,t)}),geo_detail:s(function(e,t){let r=i("/address/geo_detail");o(r,"address/geo_detail",e,t)})};return{account:h,business:I,cates:y}})("https://api.demo.pitoall.com")});})();

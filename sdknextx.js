...
(()=>{Object.defineProperty(window,"$http",{get:()=>{function $(s,t=10){let e=null;return(...r)=>{e===null&&(s(...r),e=setTimeout(()=>{e=null},t))}}function o(s,t=10){let e;return function(...r){clearTimeout(e),e=setTimeout(()=>{s(...r)},t)}}function a(s,t){return typeof s=="function"&&s(t)}function i(s,t){return new URL(s,t||document.baseURI).toString()}function d(s,t,e,r){if(!navigator.onLine)return a(r,{result:!1,code:400,message:"No internet connection"});fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:t,payLoad:e||{}})}).then(l=>{if(!l||!l.ok)throw new Error(l.statusText);return l.json()}).then(l=>{a(r,l)}).catch(l=>a(r,{result:!1,code:400,message:l.message||""}))}function g(s,t){if(!navigator.onLine)return a(t,{result:!1,code:400,message:"No internet connection"});fetch(s).then(e=>{if(!e.ok)throw new Error(e.statusText);return e.json()}).then(e=>{a(t,e)}).catch(e=>{a(t,{result:!1,code:400,message:e.message||""})})}function p(s){if(!s)return"";let t=s?.filterRules??[],e=s?.type??"and";if(e&&t.length>0){let u=t.map(c=>p(c)).filter(c=>c);return u.length>0?` ( ${u.join(` ${e} `)} ) `:""}let r=s?.field?.trim()??"",l=s?.op??"=",n=s?.value??"";return r?(n.startsWith("{{")&&n.endsWith("}}")?n=n.slice(2,-2):typeof n=="string"&&(n=n.trim(),n=`'${n}'`),`${r} ${l} ${n}`):""}function v(s){if(!s)return"";let t=s?.select??{},e=s?.where??{},r=s?.group??[],l=s?.order??{},n=s?.limit??100,u=s?.start??0,c=p(e),I="*";t&&(I=Object.keys(t).map(f=>`${t[f]} as ${f}`).join(","));let y=r.join(","),q=Object.keys(l).map(f=>`${f} ${l[f]}`).join(",");return{select:I,where:c,group:y,order:q,limit:n,start:u}}var h=(s=>({login:o(function(t,e,r){let l=i("/user/login",s);d(l,"users/login",{username:t,password:e},r)},500),generateQrcode:o(function(t,e){let r=i("/user/generate-qrcode");d(r,"users/generate-qrcode",t,e)},200),checkQrcode:o(function(t,e){let r=i("/user/check-qrcode");d(r,"users/check-qrcode",t,e)}),loginQrcode:o(function(t,e){let r=i("/user/login-qrcode");d(r,"users/login-qrcode",t,e)}),register:o(function(t,e){let r=i("/user/register");d(r,"users/register",t,e)},500),resendCode:o(function(t,e){let r=i("/user/resend-code");d(r,"users/resend-code",t,e)}),verifyCode:o(function(t,e){let r=i("/user/verify-code");d(r,"users/verify-code",t,e)}),forgotPassword:o(function(t,e){let r=i("/user/forgot-password");d(r,"users/forgot-password",t,e)}),setNewPassword:o(function(t,e){let r=i("/user/set-new-password");d(r,"users/set-new-password",t,e)}),profile:o(function(t,e){let r=i("/user/profile");d(r,"users/profile",t,e)}),updateProfile:o(function(t,e){let r=i("/user/update-profile");d(r,"users/update-profile",t,e)}),changePassword:o(function(t,e){let r=i("/user/change-password");d(r,"users/change-password",t,e)}),logout:o(function(t){let e=i("/user/logout");d(e,"users/logout",{},t)})}))("https://account.demo.pitoall.com"),m=(s=>({createOrUpdate:o(function(t,e){let r=i("/organize/create_update",s);d(r,"organize/create",t,e)},100),taxCode:o(function(t,e){let r=i("https://api.vietqr.io/v2/business/"+t);g(r,l=>{l&&l.code=="00"?a(e,{result:!0,code:200,data:l.data}):a(e,{result:!1,code:400,message:""})})}),banks:o(function(t){let e=i("https://api.vietqr.io/v2/banks");g(e,r=>{r&&r.code=="00"?a(t,{result:!0,code:200,data:{data:r.data,total:r.data.length}}):a(t,{result:!1,code:400,message:""})})}),list:o(function(t,e){let r=i("/organize/list"),l="organize/list",n=v(t);d(r,l,n,e)},500)}))("https://groups.demo.pitoall.com"),w=(s=>({address_update:function(t,e){let r=i("/address/update",s);d(r,"address/update",t,e)},address_list:o(function(t,e){let r=i("/address/list",s),l="address/list",n=v(t);d(r,l,n,e)},500),geo_address:o(function(t,e){let r=i("/address/geo_autocomplete",s);d(r,"address/geo_autocomplete",t,e)}),geo_detail:o(function(t,e){let r=i("/address/geo_detail",s);d(r,"address/geo_detail",t,e)})}))("https://groups.demo.pitoall.com");return{account:h,business:m,cates:w}}});})();

let wasm_bindgen;
(()=>{var R=(()=>{let S=Object.getPrototypeOf,E,z,p,j,y={isConnected:1},x=1e3,F,$={},w=S(y),T=S(S),L,O=(i,u,g,l)=>(i??(setTimeout(g,l),new Set)).add(u),P=(i,u,g)=>{let l=p;p=u;try{return i(g)}catch(h){return console.error(h),g}finally{p=l}},N=i=>i.filter(u=>u._dom?.isConnected),W=i=>F=O(F,i,()=>{for(let u of F)u._bindings=N(u._bindings),u._listeners=N(u._listeners);F=L},x),I={get val(){return p?._getters?.add(this),this.rawVal},get oldVal(){return p?._getters?.add(this),this._oldVal},set val(i){p?._setters?.add(this),i!==this.rawVal&&(this.rawVal=i,this._bindings.length+this._listeners.length?(z?.add(this),E=O(E,this,k)):this._oldVal=i)}},d=i=>Object.create(I,{rawVal:{value:i,writable:!0,enumerable:!0,configurable:!0},_oldVal:{value:i,writable:!0,enumerable:!0,configurable:!0},_bindings:{value:[],writable:!0,enumerable:!0,configurable:!0},_listeners:{value:[],writable:!0,enumerable:!0,configurable:!0}}),e=(i,u)=>{let g={_getters:new Set,_setters:new Set},l={f:i},h=j;j=[];let v=P(i,g,u);v=(v??document).nodeType?v:new Text(v);for(let b of g._getters)g._setters.has(b)||(W(b),b._bindings.push(l));for(let b of j)b._dom=v;return j=h,l._dom=v},t=(i,u=d(),g)=>{let l={_getters:new Set,_setters:new Set},h={f:i,s:u};h._dom=g??j?.push(h)??y,u.val=P(i,l,u.rawVal);for(let v of l._getters)l._setters.has(v)||(W(v),v._listeners.push(h));return u},a=(i,...u)=>{for(let g of u.flat(1/0)){let l=S(g??0),h=l===I?e(()=>g.val):l===T?e(g):g;h!=L&&i.append(h)}return i},s=(i,u,...g)=>{let[l,...h]=S(g[0]??0)===w?g:[{},...g],v=i?document.createElementNS(i,u):document.createElement(u);for(let[b,G]of Object.entries(l)){let r=C=>C?Object.getOwnPropertyDescriptor(C,b)??r(S(C)):L,n=u+","+b,c=$[n]??($[n]=r(S(v))?.set??0),A=b.startsWith("on")?(C,V)=>{let Y=b.slice(2);v.removeEventListener(Y,V),v.addEventListener(Y,C)}:c?c.bind(v):v.setAttribute.bind(v,b),_=S(G??0);b.startsWith("on")||_===T&&(G=t(G),_=I),_===I?e(()=>(A(G.val,G._oldVal),v)):A(G)}return a(v,...h)},o=i=>({get:(u,g)=>s.bind(L,i,g)}),f=new Proxy(i=>new Proxy(s,o(i)),o()),m=(i,u)=>u?u!==i&&i.replaceWith(u):i.remove(),k=()=>{let i=0,u=[...E].filter(l=>l.rawVal!==l._oldVal);do{z=new Set;for(let l of new Set(u.flatMap(h=>h._listeners=N(h._listeners))))t(l.f,l.s,l._dom),l._dom=L}while(++i<100&&(u=[...z]).length);let g=[...E].filter(l=>l.rawVal!==l._oldVal);E=L;for(let l of new Set(g.flatMap(h=>h._bindings=N(h._bindings))))m(l._dom,e(l.f,l._dom)),l._dom=L;for(let l of g)l._oldVal=l.rawVal};return{add:a,tags:f,state:d,derive:t,hydrate:(i,u)=>m(i,e(u,i))}})();var le=S=>{let{fromEntries:E,entries:z,keys:p}=Object,{get:j,set:y,deleteProperty:x,ownKeys:F}=Reflect,{state:$,derive:w,add:T}=S,L,O=1e3,P,N,W=Symbol(),I=Symbol(),d=Symbol(),e=Symbol(),t=Symbol(),a=Symbol(),s=r=>(r[d]=1,r),o=r=>{if(r?.[d]){let n=$();return w(()=>{let c=r();n.rawVal instanceof Object&&c instanceof Object?b(n.rawVal,c):n.val=f(c)}),n}else return $(f(r))},f=r=>!(r instanceof Object)||r[I]?r:new Proxy((r[W]=r,r[I]=E(z(r).map(([n,c])=>[n,o(c)])),r[e]=[],r[t]=$(1),r),{get:(n,c,A)=>n[I].hasOwnProperty(c)?n[I][c].val:(c==="length"&&n[t].val,j(n,c,A)),set(n,c,A,_){let C=n[I];if(C.hasOwnProperty(c))return C[c].val=f(A),1;let V=c in n,Y=V&&c==="length"&&A!==n.length;if(y(n,c,A))return V?Y&&++n[t].val:y(C,c,o(A))&&(++n[t].val,u(_,c,C[c])),1},deleteProperty:(n,c)=>(x(n[I],c)&&g(n,c),x(n,c)&&++n[t].val),ownKeys:n=>(n[t].val,F(n))}),m=r=>r[I],k=r=>r[I]?new Proxy(r[I],{get:(n,c)=>k(n[c].rawVal)}):r,D=r=>r[e]=r[e].filter(n=>n._containerDom.isConnected),i=(r,n,c,A,{_containerDom:_,f:C})=>{let V=Array.isArray(r);if(T(_,()=>_[a][n]=C(c,()=>delete r[n],V?Number(n):n)),V&&!A&&n!=r.length-1){let Y=Number(n);_.insertBefore(_.lastChild,_[a][p(r).find(J=>Number(J)>Y)])}},u=(r,n,c)=>D(r).forEach(i.bind(P,r,n,c,N)),g=(r,n)=>{for(let c of D(r)){let A=c._containerDom[a];A[n]?.remove(),delete A[n]}},l=r=>(L??(L=(setTimeout(()=>(L.forEach(D),L=P),O),new Set))).add(r),h=(r,n,c)=>{let A={_containerDom:r instanceof Function?r():r,f:c};A._containerDom[a]={},n[e].push(A),l(n);for(let[_,C]of z(n[I]))i(n,_,C,1,A);return A._containerDom},v=(r,n)=>{for(let[_,C]of z(n)){let V=r[_];V instanceof Object&&C instanceof Object?v(V,C):r[_]=C}for(let _ in r)n.hasOwnProperty(_)||delete r[_];let c=p(n),A=Array.isArray(r);if(A||p(r).some((_,C)=>_!==c[C])){if(A)r.length=n.length;else{++r[t].val;let _=r[W],C={..._};for(let V of c)delete _[V];for(let V of c)_[V]=C[V]}for(let{_containerDom:_}of D(r)){let{firstChild:C,[a]:V}=_;for(let Y of c)C===V[Y]?C=C.nextSibling:_.insertBefore(V[Y],C)}}return r},b=(r,n)=>{N=1;try{return v(r,n instanceof Function?Array.isArray(r)?n(r.filter(c=>1)):E(n(z(r))):n)}finally{N=P}},G=r=>Array.isArray(r)?r.filter(n=>1).map(G):r instanceof Object?E(z(r).map(([n,c])=>[n,G(c)])):r;return{calc:s,reactive:f,stateFields:m,raw:k,list:h,replace:b,compact:G}};var ne=(()=>{function S(y){return/^[a-zA-Z_][a-zA-Z_0-9]+$/.test(y)?y:`"${y}"`}function E(y=""){let x=[];if(y.includes("{{")&&y.includes("}}")){let $=y.indexOf("{{"),w=y.indexOf("}}"),T=y.slice(0,$).trim(),L=y.slice(w+2).trim(),O=y.slice($+2,w).trim();if(T.length>0&&x.push(JSON.stringify(T)),O.length>0&&x.push(O),L.length>0){let P=E(L).filter(N=>N);L.length>0&&x.push(...P)}}else x.push(JSON.stringify(y));let F=x.filter($=>$);return F.length===0?[]:F}function z(y,x=new Set){if(y.nodeType===3){let t=E(y.nodeValue.trim()).filter(a=>a&&a!='""').join(",");return{tags:x,body:t}}if(!y.tagName)return{tags:x,body:""};let F=y.tagName.toLowerCase();x.add(F);let $=[],w={};Array.from(y.attributes).forEach(e=>{w[e.name.trim()]=e.value.trim()}),w.hasOwnProperty("x-tags")&&(w["x-tags"].split(/[\s|,]+/).map(t=>t.trim()).filter(t=>t).forEach(t=>{x.add(t.toLowerCase())}),delete w["x-tags"]),Object.keys(w).forEach(e=>{if(e.startsWith("x-state:")||e.startsWith("x-reactive:")||e.startsWith("x-stateFields:")||e.startsWith("x-derive")||e.startsWith("x-script")){if(e.startsWith("x-state:")){let t=e.split(":")[1];$.push(`const ${t.trim()}=tjs.state(${w[e].trim()});`)}else if(e.startsWith("x-derive"))if(e.includes(":")){let t=e.split(":")[1];$.push(`const ${t.trim()}=tjs.derive(${w[e].trim()});`)}else $.push(`tjs.derive(${w[e].trim()});`);else if(e.startsWith("x-reactive:")){let t=e.split(":")[1];$.push(`const ${t.trim()}=tjs.reactive(${w[e].trim()});`)}else if(e.startsWith("x-stateFields:")){let t=e.split(":")[1];$.push(`const ${t.trim()}=tjs.stateFields(${w[e].trim()});`)}else $.push(w[e]);delete w[e]}});let T="";w["x-list"]&&(T=w["x-list"]||"",delete w["x-list"]);let L=Object.keys(w).map(e=>{if(e.startsWith("x-")){let t=e.substr(2);return`${S(t)}:${w[e]||""}`}else return`${S(e)}:${JSON.stringify(w[e])}`}).join(","),O=[],P="";F==="script"?P=JSON.stringify(y.textContent):(O=Array.from(y.childNodes).map(e=>z(e,x)),P=O.filter(e=>e.body).map(e=>e.body).join(","));let N=F.replace(/-/g,"_"),W="";var I=()=>{if(T){let e=T.match(/^\s*(\()?(?<k>[^\(\)]+)(\))?\s+in\s+(?<d>[a-zA-Z0-9\.\$_]+)\s*$/);if(e){let{k:t,d:a}=e.groups;W=`tjs.list(${N},${a},(${t}) =>${P||""})`}}};Object.keys(w).length>0?(W=`${N}({${L}} ${P?","+P:""})`,I()):(W=P?`${N}(${P})`:`${N}()`,I());let d=W;return $.length>0&&(d=`()=>{ ${$.join(`
`)} return ${W};}`),{tags:x,body:d}}function p(y,x){let w=new DOMParser().parseFromString(x,"text/html").body;return j(y,w)}function j(y,x){let F=[];for(let T of x.childNodes)F.push(z(T));let $=F.filter(T=>T.tags.size>0),w="";if($.length>0){let T=new Set;$.forEach(O=>{O.tags.forEach(P=>T.add(P))}),w=`const {${[...T].map(O=>/-/.test(O)?`"${O}":${O.replace(/-/g,"_")}`:O).join(", ")}}=tjs.tags;`}return[`${y}.replaceChildren();`,w,...$.map(T=>`tjs.add(${y}, ${T.body});`)]}return{addHtmToElement:p,domToJs:j}})();var ie=S=>{function E(z,p,j={mode:"open"}){window.customElements.define(z,class extends HTMLElement{constructor(){super(),this.attrs=[]}setAttribute(y,x){super.setAttribute(y,x),this.attrs[y]&&(this.attrs[y].val=x)}connectedCallback(){let y;S.add(j?this.attachShadow(j):this,p({attr:(x,F)=>this.attrs[x]??=S.state(this.getAttribute(x)??F),mount:x=>y=x,$this:this,children:j?S.tags.slot():[...this.childNodes]})),this.dismount=y?.()}disconnectedCallback(){this.dismount?.()}})}return{define:E}};var ae=S=>{let E=0,{button:z,div:p,header:j,input:y,label:x,span:F,style:$}=S.tags,w=d=>Object.entries(d).map(([e,t])=>`${e}: ${t};`).join(""),T=d=>{},L=Object.getPrototypeOf(S.state(null)),O=d=>Object.getPrototypeOf(d??0)===L?d:S.state(d),P=({value:d,container:e=p,Loading:t,Error:a},s)=>{let o=S.state({status:"pending"});return d.then(f=>o.val={status:"fulfilled",value:f}).catch(f=>o.val={status:"rejected",value:f}),e(()=>o.val.status==="pending"?t?.()??"":o.val.status==="rejected"?a?.(o.val.value):s(o.val.value))},N=()=>++E,W=({title:d,closed:e=S.state(!1),x:t=100,y:a=100,width:s=300,height:o=200,closeCross:f="\xD7",customStacking:m=!1,zIndex:k=1,disableMove:D=!1,disableResize:i=!1,headerColor:u="lightgray",windowClass:g="",windowStyleOverrides:l={},headerClass:h="",headerStyleOverrides:v={},childrenContainerClass:b="",childrenContainerStyleOverrides:G={},crossClass:r="",crossStyleOverrides:n={},crossHoverClass:c="",crossHoverStyleOverrides:A={}},..._)=>{let C=O(t),V=O(a),Y=O(s),J=O(o),q=O(k);m||(q.val=N());let U=S.state(!1),X=S.state(null),B=S.state(0),K=S.state(0),te=S.state(0),re=S.state(0),Z=c||Object.keys(A)?S.state(!1):null,se=M=>{M.button===0&&(U.val=!0,B.val=M.clientX,K.val=M.clientY,document.body.style.userSelect="none")},Q=M=>H=>{X.val=M,B.val=H.clientX,K.val=H.clientY,te.val=Y.val,re.val=J.val,document.body.style.userSelect="none"},de=M=>{if(U.val)C.val+=M.clientX-B.val,V.val+=M.clientY-K.val,B.val=M.clientX,K.val=M.clientY;else if(X.val){let H=M.clientX-B.val,ue=M.clientY-K.val;X.val.includes("right")&&(Y.val=te.val+H),X.val.includes("bottom")&&(J.val=re.val+ue)}},ce=()=>{U.val=!1,X.val=null,document.body.style.userSelect=""};document.addEventListener("mousemove",de),document.addEventListener("mouseup",ce);let ee="transparent";if(!document.getElementById("tjsui-window-style")){let M=$({type:"text/css",id:"tjsui-window-style"},T({".tjsui-window":{position:"fixed","background-color":"white",border:"1px solid black","border-radius":"0.5rem",overflow:"hidden"},".tjsui-window-dragarea":{cursor:"move",position:"absolute",left:"0",top:"0",width:"100%",height:"1rem"},".tjsui-window-resize-right":{cursor:"e-resize",position:"absolute",right:"0",top:"0",width:"10px",height:"100%","background-color":ee},".tjsui-window-resize-bottom":{cursor:"s-resize",position:"absolute",left:"0",bottom:"0",width:"100%",height:"10px","background-color":ee},".tjsui-window-resize-rightbottom":{cursor:"se-resize",position:"absolute",right:"0",bottom:"0",width:"10px",height:"10px","background-color":ee},".tjsui-window-header":{cursor:"move","user-select":"none",display:"flex","justify-content":"space-between","align-items":"center",padding:"0.5rem"},".tjsui-window-cross":{cursor:"pointer","font-family":"Arial",transition:"background-color 0.3s, color 0.3s","border-radius":"50%",width:"24px",height:"24px",display:"flex","align-items":"center","justify-content":"center"},".tjsui-window-cross:hover":{"background-color":"red",color:"white"},".tjsui-window-children":{padding:"0.5rem"}}));document.head.appendChild(M)}return()=>e.val?null:p({class:["tjsui-window"].concat(g||[]).join(" "),style:()=>w({left:`${C.val}px`,top:`${V.val}px`,width:`${Y.val}px`,height:`${J.val}px`,"z-index":q.val,...l}),...m?{}:{onmousedown:()=>q.val=N()}},d?j({class:["tjsui-window-header"].concat(h||[]).join(" "),style:w({"background-color":u,...D?{cursor:"auto"}:{},...v}),...D?{}:{onmousedown:se}},d,f?F({class:()=>["tjsui-window-cross"].concat(r||[]).concat(c&&Z.val?c:[]).join(" "),style:()=>w({...n,...Object.keys(A).length&&Z.val?A:{}}),onclick:()=>e.val=!0,...Z?{onmouseenter:()=>Z.val=!0,onmouseleave:()=>Z.val=!1}:{}},f):null):D?null:p({class:"tjsui-window-dragarea",onmousedown:se}),i?[]:[p({class:"tjsui-window-resize-right",onmousedown:Q("right")}),p({class:"tjsui-window-resize-bottom",onmousedown:Q("bottom")}),p({class:"tjsui-window-resize-rightbottom",onmousedown:Q("rightbottom")})],p({class:["tjsui-window-children"].concat(b||[]).join(" "),style:w(G)},_))};class I{_fadeOutSec;_messageClass;_messageStylesStr;_closerClass;_closerStylesStr;_dom;constructor({top:e="unset",bottom:t="unset",backgroundColor:a="#333D",fontColor:s="white",fadeOutSec:o=.3,boardClass:f="",boardStyleOverrides:m={},messageClass:k="",messageStyleOverrides:D={},closerClass:i="",closerStyleOverrides:u={}},g=document.body){let l=w({display:"flex","flex-direction":"column","align-items":"center",position:"fixed",top:e,bottom:t,left:"50%",transform:"translateX(-50%)","z-index":1e4,...m});this._fadeOutSec=o,this._messageClass=k,this._messageStylesStr=w({display:"flex","background-color":a,color:s,padding:"15px","margin-bottom":"10px","border-radius":"5px",transition:`opacity ${o}s, transform ${o}s`,...D}),this._closerClass=i,this._closerStylesStr=w({display:"flex","align-items":"center","margin-left":"10px",cursor:"pointer",...u}),g.appendChild(this._dom=p({class:f,style:l}))}show({message:e,closer:t,durationSec:a,closed:s=S.state(!1)}){let o=S.state(!1);S.derive(()=>setTimeout(m=>o.val=m,this._fadeOutSec*1e3,s.val));let f=p({class:this._messageClass,style:this._messageStylesStr},p(e),t?p({class:this._closerClass,style:this._closerStylesStr,onclick:()=>s.val=!0},t):null);return S.derive(()=>s.val&&(f.style.opacity="0",f.style.transform="translateY(-20px)")),a&&setTimeout(()=>s.val=!0,a*1e3),S.add(this._dom,()=>o.val?null:f),f}remove(){this._dom.remove()}}return{Await:P,MessageBoard:I,topMostZIndex:N,FloatingWindow:W}};var oe=(S,E)=>{let z=/^(?<p>[a-z]+)(?<v>(([A-Z0-9\{])|--|-).*)?$/,p={default:[new Set,new Set],xs:[new Set,new Set],sm:[new Set,new Set],md:[new Set,new Set],lg:[new Set,new Set],xl:[new Set,new Set],"2xl":[new Set,new Set]},j={default:[new CSSStyleSheet,new CSSStyleSheet],xs:[new CSSStyleSheet({media:"screen and (max-width: 575px)"}),new CSSStyleSheet({media:"screen and (max-width: 575px)"})],sm:[new CSSStyleSheet({media:"screen and (min-width: 576px)"}),new CSSStyleSheet({media:"screen and (min-width: 576px)"})],md:[new CSSStyleSheet({media:"screen and (min-width: 768px)"}),new CSSStyleSheet({media:"screen and (min-width: 768px)"})],lg:[new CSSStyleSheet({media:"screen and (min-width: 992px)"}),new CSSStyleSheet({media:"screen and (min-width: 992px)"})],xl:[new CSSStyleSheet({media:"screen and (min-width: 1200px)"}),new CSSStyleSheet({media:"screen and (min-width: 1200px)"})],"2xl":[new CSSStyleSheet({media:"screen and (min-width: 1400px)"}),new CSSStyleSheet({media:"screen and (min-width: 1400px)"})]},y=(d="")=>{let e=d.match(z);if(!e)return[];let{p:t,v:a}=e.groups,s=E[t];if(!s)return t=="cf"?a&&(a=[a[0].toLowerCase(),a.substr(1)].join(""),typeof window.TFL_STYLE_CONFIG=="object"&&Object.keys(window.TFL_STYLE_CONFIG).length>0&&window.TFL_STYLE_CONFIG[a])?typeof window.TFL_STYLE_CONFIG[a]=="string"?[window.TFL_STYLE_CONFIG[a]]:window.TFL_STYLE_CONFIG[a]:[]:[];let o=[],f="";if(a&&a.endsWith("!")&&(a=a.substr(0,a.length-1),f="!important"),t.length==d.length&&s.cssText)return typeof s.cssText=="string"?[s.cssText]:Array.isArray(s.cssText)?s.cssText:[];if(s.names&&typeof s.names=="string"&&(o=[s.names]),s.names&&Array.isArray(s.names)&&(o=s.names),t.length==d.length&&s.default&&o.length>0)return o.map(k=>`${k}:${s.default}${f}`);if(!a&&typeof s.fn=="function"){let m=s.fn();if(typeof m=="string")return[m];if(Array.isArray(m))return m}if(a){if(!s.default&&!s.cssText&&typeof s.fn=="function"){let l=[a[0].toLowerCase(),a.substr(1)].join(""),h=s.fn(l);if(h)return[h]}let m=/^\{(?<v>.+)\}$/,k=/^(?<v>--[a-z0-9-]+)$/,D=/^(?<d1>(-)?\d+)\/(?<d2>\d+)$/,i=a.match(m);if(i){let{v:l}=i.groups;l=l.toLowerCase(),l=l.replace(/[_]+/g,b=>b.length%2==1?" ":b.substr(0,b.length/2));let h=o.map(b=>`${b}:${l}${f}`);return h.every(b=>CSS.supports(b))?h:[]}if(i=a.match(k),i){let{v:l}=i.groups;return o.map(v=>`${v}:var(${l})${f}`)}if(i=a.match(D),i){let{d1:l,d2:h}=i.groups;if(Number(h)>0){let v=o.map(b=>`${b}:calc(${l} * 100% / ${h})`);if(v.every(b=>CSS.supports(b)))return v}}let u=[a[0].toLowerCase(),a.substr(1)].join(""),g=s.exts&&Object.keys(s.exts).length>0?s.exts[u]:"";if(g)return o.map(h=>`${h}:${g}${f}`);{let l=o.map(h=>`${h}:${u}${f}`);if(l.every(h=>CSS.supports(h)))return l}if(typeof s.fn=="function"){let l=s.fn(u);if(l){let h=o.map(v=>`${v}:${l}${f}`);if(h.every(v=>CSS.supports(v)))return h}}}return[]},x=d=>{let e=y(d);return Array.isArray(e)&&e.length>0?e.join(";"):""},F=d=>{var e=/class="([^"]+)"/g,t=[];return[...d.matchAll(e)].forEach(a=>t=t.concat(a[1].split(" "))),[...new Set(t)]},$=d=>{if(!d)return[];let e=[].concat(...[...d.querySelectorAll("[class]")].map(a=>[...a.classList]));return[...new Set(e)]},w=d=>{let t=(d||"").match(/((?<m>(xs|sm|md|lg|xl|2xl))\:)?(?<v>.+$)/);if(t){let{m:s,v:o=""}=t.groups,f="";var a=(i,u=!0)=>{if(typeof i=="string"){let g=o.indexOf(i);u&&(g+=1),f=o.substr(g),o=o.substr(0,o.length-f.length)}else{let g=(i||[]).map(l=>[l,o.indexOf(l)]);if(g=g.filter(l=>l[1]>-1),g.length>0){g.sort((h,v)=>h[1]>=v[1]?1:-1);let l=g[0][1];u&&(l+=1),f=o.substr(l),o=o.substr(0,o.length-f.length)}}};o.indexOf("}")>-1?a("}"):a([":","_",">","+","~","*"],!1);let m=x(o);if(!m)return null;let k=CSS.escape(d),D=f?f.replace(/([\^\|\~\*\$]\=|_|\+|\~|\*|\>)/g,i=>i=="_"?" ":["~","+","*",">"].includes(i)?` ${i} `:i):"";return{type:s||"default",ext:!!D,css:`.${k}${D} {${m}}`,selectorText:`.${k}${D}`}}return null},T=(d=[])=>d.map(t=>w(t)).filter(t=>t),L=(d,e,t="")=>t?(j[d]&&j[d][e]&&t.length>0&&j[d][e].insertRule(t),!0):!1,O=(d,e,t=[])=>t.length==0?!1:j[d]&&j[d][e]?(j[d][e].replaceSync(t.join(`
`)),!0):!1,P=(d=[])=>{let e=T(d);for(let t of Object.keys(p)){let a=e.filter(m=>m.type==t&&m.ext==!1),s=e.filter(m=>m.type==t&&m.ext==!0),o=a.map(m=>m.css),f=s.map(m=>m.css);if(o.length>0)for(let m of o)p[t][0].has(m)||(p[t][0].add(m),L(t,0,m));if(f.length>0)for(let m of f)p[t][1].has(m)||p[t][1].add(m),L(t,1,m)}},N=d=>{new MutationObserver(e=>{for(let t of e)if(t.type=="attributes"&&t.attributeName=="class"){let s=[...t.target.classList].map(o=>o.trim()).filter(o=>o);typeof d=="function"&&d([...new Set(s)])}else if(t.type=="childList"&&t.addedNodes.length>0){let a=[...t.addedNodes].filter(s=>s.nodeType!=3).map(s=>[...s.classList]).flat(1/0).map(s=>s.trim()).filter(s=>s);typeof d=="function"&&d([...new Set(a)])}}).observe(document.documentElement,{attributes:!0,attributeFilter:["class"],childList:!0,subtree:!0})},W=()=>{let d;return e=>{clearTimeout(d),d=setTimeout(()=>{Object.keys(p).forEach(t=>{let a="tfl-"+t+"-0",s="tfl-"+t+"-1";p[t][0].size>0&&localStorage.setItem(a,JSON.stringify([...p[t][0]])),p[t][1].size>0&&localStorage.setItem(s,JSON.stringify([...p[t][1]]))})},e||0)}};return{loadEventDom:()=>{var d=Object.values(j).flat();let e=new CSSStyleSheet;S&&Array.isArray(S)&&e.replaceSync(S.join(`
...
`);new Function(z)()});let S=setInterval(()=>{if(document&&document.body&&document.body.isConnected){let E=new Event("tjs-load");dispatchEvent(E),clearInterval(S)}},1)})();})();

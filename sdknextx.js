...
(()=>{Object.defineProperty(window,"$http",{get:()=>(h=>{function k(e,r=10){let t=null;return(...l)=>{t===null&&(e(...l),t=setTimeout(()=>{t=null},r))}}function i(e,r=10){let t;return function(...l){clearTimeout(t),t=setTimeout(()=>{e(...l)},r)}}function a(e,r){return typeof e=="function"&&e(r)}function s(e){return new URL(e,h||document.baseURI).toString()}function d(e,r,t,l){if(!navigator.onLine)return a(l,{result:!1,code:400,message:"No internet connection"});fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:r,payLoad:t||{}})}).then(o=>{if(!o||!o.ok)throw new Error(o.statusText);return o.json()}).then(o=>{a(l,o)}).catch(o=>a(l,{result:!1,code:400,message:o.message||""}))}function g(e,r){if(!navigator.onLine)return a(r,{result:!1,code:400,message:"No internet connection"});fetch(e).then(t=>{if(!t.ok)throw new Error(t.statusText);return t.json()}).then(t=>{a(r,t)}).catch(t=>{a(r,{result:!1,code:400,message:t.message||""})})}function v(e){if(!e)return"";let r=e?.filterRules??[],t=e?.type??"and";if(t&&r.length>0){let f=r.map(u=>v(u)).filter(u=>u);return f.length>0?` ( ${f.join(` ${t} `)} ) `:""}let l=e?.field?.trim()??"",o=e?.op??"=",n=e?.value??"";return l?(n.startsWith("{{")&&n.endsWith("}}")?n=n.slice(2,-2):typeof n=="string"&&(n=n.trim(),n=`'${n}'`),`${l} ${o} ${n}`):""}function p(e){if(!e)return"";let r=e?.select??{},t=e?.where??{},l=e?.group??[],o=e?.order??{},n=e?.limit??100,f=e?.start??0,u=v(t),I="*";r&&(I=Object.keys(r).map(c=>`${r[c]} as ${c}`).join(","));let q=l.join(","),$=Object.keys(o).map(c=>`${c} ${o[c]}`).join(",");return{select:I,where:u,group:q,order:$,limit:n,start:f}}var m={login:i(function(e,r,t){let l=s("/user/login");d(l,"users/login",{username:e,password:r},t)},500),generateQrcode:i(function(e,r){let t=s("/user/generate-qrcode");d(t,"users/generate-qrcode",e,r)},200),checkQrcode:i(function(e,r){let t=s("/user/check-qrcode");d(t,"users/check-qrcode",e,r)}),loginQrcode:i(function(e,r){let t=s("/user/login-qrcode");d(t,"users/login-qrcode",e,r)}),register:i(function(e,r){let t=s("/user/register");d(t,"users/register",e,r)},500),resendCode:i(function(e,r){let t=s("/user/resend-code");d(t,"users/resend-code",e,r)}),verifyCode:i(function(e,r){let t=s("/user/verify-code");d(t,"users/verify-code",e,r)}),forgotPassword:i(function(e,r){let t=s("/user/forgot-password");d(t,"users/forgot-password",e,r)}),setNewPassword:i(function(e,r){let t=s("/user/set-new-password");d(t,"users/set-new-password",e,r)}),profile:i(function(e,r){let t=s("/user/profile");d(t,"users/profile",e,r)}),updateProfile:i(function(e,r){let t=s("/user/update-profile");d(t,"users/update-profile",e,r)}),changePassword:i(function(e,r){let t=s("/user/change-password");d(t,"users/change-password",e,r)}),logout:i(function(e,r){let t=s("/user/logout");d(t,"users/logout",e,r)})},w={createOrUpdate:i(function(e,r){let t=s("/organize/create_update");d(t,"organize/create",e,r)},100),taxCode:i(function(e,r){let t=s("https://api.vietqr.io/v2/business/"+e);g(t,l=>{l&&l.code=="00"?a(r,{result:!0,code:200,data:l.data}):a(r,{result:!1,code:400,message:""})})}),banks:i(function(e){let r=s("https://api.vietqr.io/v2/banks");g(r,t=>{t&&t.code=="00"?a(e,{result:!0,code:200,data:{data:t.data,total:t.data.length}}):a(e,{result:!1,code:400,message:""})})}),list:i(function(e,r){let t=s("/organize/list"),l="organize/list",o=p(e);d(t,l,o,r)},500)},y={address_update:function(e,r){let t=s("/address/update");d(t,"address/update",e,r)},address_list:i(function(e,r){let t=s("/address/list"),l="address/list",o=p(e);d(t,l,o,r)},500),geo_address:i(function(e,r){let t=s("/address/geo_autocomplete");d(t,"address/geo_autocomplete",e,r)}),geo_detail:i(function(e,r){let t=s("/address/geo_detail");d(t,"address/geo_detail",e,r)})};return{account:m,business:w,cates:y}})("https://api.demo.pitoall.com")});})();

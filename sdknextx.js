...
`);new Function(`(() => {try {${j}} catch (e) {console.error(e); }})()`)()});let g=setInterval(()=>{if(document&&document.body&&document.body.isConnected){let T=new Event("tjs-load");dispatchEvent(T),clearInterval(g)}},1)})();})();

...
(()=>{Object.defineProperty(window,"$http",{get:()=>{function S(t,r=10){let d=null;return(...i)=>{d===null&&(t(...i),d=setTimeout(()=>{d=null},r))}}function n(t,r=10){let d;return function(...i){clearTimeout(d),d=setTimeout(()=>{t(...i)},r)}}function c(t,r){return typeof t=="function"&&t(r)}function s(t,r){return new URL(t,r||document.baseURI).toString()}function u(t,r,d,i){if(!navigator.onLine)return c(i,{result:!1,code:400,message:"No internet connection"});fetch(t,{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:r,payLoad:d||{}})}).then(e=>{if(!e||!e.ok)throw new Error(e.statusText);return e.json()}).then(e=>{c(i,e)}).catch(e=>c(i,{result:!1,code:400,message:e.message||""}))}function v(t,r){if(!navigator.onLine)return c(r,{result:!1,code:400,message:"No internet connection"});fetch(t).then(d=>{if(!d.ok)throw new Error(d.statusText);return d.json()}).then(d=>{c(r,d)}).catch(d=>{c(r,{result:!1,code:400,message:d.message||""})})}function g(t){if(!t)return"";let r=t?.filterRules??[],d=t?.type??"and";if(d&&r.length>0){let o=r.map(a=>g(a)).filter(a=>a);return o.length>0?` ( ${o.join(` ${d} `)} ) `:""}let i=t?.field?.trim()??"",e=t?.op??"=",l=t?.value??"";return i?(l.startsWith("{{")&&l.endsWith("}}")?l=l.slice(2,-2):typeof l=="string"&&(l=l.trim(),l=`s'${l}'`),`${i} ${e} ${l}`):""}function p(t){if(!t)return"";let r=t?.id??"",d=t?.select??{},i=t?.where??{},e=t?.group??[],l=t?.order??{},o=t?.limit??100,a=t?.start??0,y=g(i),I="*";d&&(I=Object.keys(d).map(f=>`${d[f]} as ${f}`).join(","));let _=e.join(","),$=Object.keys(l).map(f=>`${f} ${l[f]}`).join(",");return{id:r,select:I,where:y,group:_,order:$,limit:o,start:a}}function h(t,r){if(typeof window.flutter_inappwebview>"u"||typeof window.flutter_inappwebview.callHandler>"u")return c(r,null);typeof window.flutter_inappwebview.callHandler=="function"?window.flutter_inappwebview.callHandler("TflInvoker",...t).then(d=>{c(r,d)}):c(r,null)}var w=(t=>{var r=!1,d="";let i=null;return window.addEventListener("deviceId",function(e){e.detail&&(i=e.detail)}),typeof TflInvoker<"u"&&TflInvoker.postMessage("deviceId"),{keepOnline:n(function(e){let l=s("/user/keep-online",t);u(l,"",{},e)},500),checkAuth:n(function(e){let l=s("/user/check-token-live",t);u(l,"",{},e)},500),login:n(function(e,l){let o=s("/user/login",t);u(o,"users/login",e,l)},500),generateQrcode:n(function(e){let l=s("/user/generate-qrcode",t);u(l,"users/qrcode/generate-qrcode",{},a=>{a.code=="200"&&(r=!0,d=a.data.zid),typeof e=="function"&&e(a)})},200),checkQrcode:n(function(e,l){let o=s("/user/check-qrcode",t);u(o,"users/qrcode/check-qrcode",e,l)}),loginQrcode:n(function(e,l){let o=s("/user/login-qrcode",t);u(o,"users/qrcode/login-qrcode",e,l)}),checkScanQrCode:n(function(e,l){let o=s("/user/check-qrcode-token",t);u(o,"users/qrcode/check-qrcode-token",e,l)}),register:n(function(e,l){let o=s("/user/register",t);u(o,"users/register",e,l)},500),resendCode:n(function(e,l){let o=s("/user/resend-code",t);u(o,"users/resend-code",e,l)}),verifyCode:n(function(e,l){let o=s("/user/register-verify-code",t);u(o,"users/register-verify-code",e,l)}),forgotPasswordRequest:n(function(e,l){let o=s("/user/forgot-password",t);u(o,"users/forgot-password",e,l)}),forgotPasswordCheckCode:n(function(e,l){let o=s("/user/forgot-password-check-code",t);u(o,"users/forgot-password-check-code",e,l)}),forgotPasswordSetNewPassword:n(function(e,l){let o=s("/user/forgot-password-reset",t);u(o,"users/forgot-password-reset",e,l)}),profile:n(function(e){let l=s("/user/profile",t);u(l,"users/profile",{},e)}),updateProfile:n(function(e,l){let o=s("/user/update-profile",t);u(o,"users/update-profile",e,l)}),changePassword:n(function(e,l){let o=s("/user/change-password",t);u(o,"users/change-password",e,l)}),logout:n(function(e){let l=s("/user/logout",t);u(l,"users/logout",{},e)})}})("https://account.demo.pitoall.com"),m=(t=>({create:n(function(r,d,i,e){let l=s("/docs/create",t),o="docs/create";i={...i,gid:r,type:d},u(l,o,i,e)},100),update:n(function(r,d,i,e){let l=s("/docs/update",t);u(l,"docs/update",{gid:r,id:d,content:i},e)},100),delete:n(function(r,d,i){let e=s("/docs/delete",t);u(e,"docs/delete",{gid:r,id:d},i)},100),list:n(function(r,d,i){let e=s("/docs/list",t),l="docs/list",o=p(d);o.id=r,u(e,l,o,i)},500)}))("https://groups.demo.pitoall.com"),k=(t=>({create:n(function(r,d){let i=s("/groups/create",t);u(i,"groups/create",r,d)},100),update:n(function(r,d,i){let e=s("/groups/update",t);u(e,"groups/update",{id:r,content:d},i)},100),taxCode:n(function(r,d){let i=s("https://api.vietqr.io/v2/business/"+r);v(i,e=>{e&&e.code=="00"?c(d,{result:!0,code:200,data:e.data}):c(d,{result:!1,code:400,message:""})})}),banks:n(function(r){let d=s("https://api.vietqr.io/v2/banks");v(d,i=>{i&&i.code=="00"?c(r,{result:!0,code:200,data:{data:i.data,total:i.data.length}}):c(r,{result:!1,code:400,message:""})})}),list:n(function(r,d){let i=s("/groups/list",t),e="groups/list",l=p(r);u(i,e,l,d)},500),docs:m}))("https://groups.demo.pitoall.com"),q=(t=>({address_update:function(r,d){let i=s("/address/update",t);u(i,"address/update",r,d)},address_list:n(function(r,d){let i=s("/address/list",t),e="address/list",l=p(r);u(i,e,l,d)},500),geo_address:n(function(r,d){let i=s("/address/geo_autocomplete",t);u(i,"address/geo_autocomplete",r,d)}),geo_detail:n(function(r,d){let i=s("/address/geo_detail",t);u(i,"address/geo_detail",r,d)})}))("https://groups.demo.pitoall.com");return{account:w,business:k,cates:q,invokerMobile:n(function(t,r){h(t,r)},1)}}});})();

...
(()=>{Object.defineProperty(window,"$http",{get:()=>{function S(d,t=10){let e=null;return(...l)=>{e===null&&(d(...l),e=setTimeout(()=>{e=null},t))}}function o(d,t=10){let e;return function(...l){clearTimeout(e),e=setTimeout(()=>{d(...l)},t)}}function u(d,t){return typeof d=="function"&&d(t)}function i(d,t){return new URL(d,t||document.baseURI).toString()}function n(d,t,e,l){if(!navigator.onLine)return u(l,{result:!1,code:400,message:"No internet connection"});fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:t,payLoad:e||{}})}).then(r=>{if(!r||!r.ok)throw new Error(r.statusText);return r.json()}).then(r=>{u(l,r)}).catch(r=>u(l,{result:!1,code:400,message:r.message||""}))}function g(d,t){if(!navigator.onLine)return u(t,{result:!1,code:400,message:"No internet connection"});fetch(d).then(e=>{if(!e.ok)throw new Error(e.statusText);return e.json()}).then(e=>{u(t,e)}).catch(e=>{u(t,{result:!1,code:400,message:e.message||""})})}function v(d){if(!d)return"";let t=d?.filterRules??[],e=d?.type??"and";if(e&&t.length>0){let a=t.map(c=>v(c)).filter(c=>c);return a.length>0?` ( ${a.join(` ${e} `)} ) `:""}let l=d?.field?.trim()??"",r=d?.op??"=",s=d?.value??"";return l?(s.startsWith("{{")&&s.endsWith("}}")?s=s.slice(2,-2):typeof s=="string"&&(s=s.trim(),s=`s'${s}'`),`${l} ${r} ${s}`):""}function p(d){if(!d)return"";let t=d?.id??"",e=d?.select??{},l=d?.where??{},r=d?.group??[],s=d?.order??{},a=d?.limit??100,c=d?.start??0,q=v(l),I="*";e&&(I=Object.keys(e).map(f=>`${e[f]} as ${f}`).join(","));let $=r.join(","),k=Object.keys(s).map(f=>`${f} ${s[f]}`).join(",");return{id:t,select:I,where:q,group:$,order:k,limit:a,start:c}}var h=(d=>({login:o(function(t,e,l){let r=i("/user/login",d);n(r,"users/login",{username:t,password:e},l)},500),generateQrcode:o(function(t,e){let l=i("/user/generate-qrcode");n(l,"users/generate-qrcode",t,e)},200),checkQrcode:o(function(t,e){let l=i("/user/check-qrcode");n(l,"users/check-qrcode",t,e)}),loginQrcode:o(function(t,e){let l=i("/user/login-qrcode");n(l,"users/login-qrcode",t,e)}),register:o(function(t,e){let l=i("/user/register");n(l,"users/register",t,e)},500),resendCode:o(function(t,e){let l=i("/user/resend-code");n(l,"users/resend-code",t,e)}),verifyCode:o(function(t,e){let l=i("/user/verify-code");n(l,"users/verify-code",t,e)}),forgotPassword:o(function(t,e){let l=i("/user/forgot-password");n(l,"users/forgot-password",t,e)}),setNewPassword:o(function(t,e){let l=i("/user/set-new-password");n(l,"users/set-new-password",t,e)}),profile:o(function(t){let e=i("/user/profile");n(e,"users/profile",{},t)}),updateProfile:o(function(t,e){let l=i("/user/update-profile");n(l,"users/update-profile",t,e)}),changePassword:o(function(t,e){let l=i("/user/change-password");n(l,"users/change-password",t,e)}),logout:o(function(t){let e=i("/user/logout");n(e,"users/logout",{},t)})}))("https://account.demo.pitoall.com"),m=(d=>({create:o(function(t,e,l,r){let s=i("/docs/create",d),a="docs/create";l={...l,gid:t,type:e},n(s,a,l,r)},100),update:o(function(t,e,l,r){let s=i("/docs/update",d);n(s,"docs/update",{gid:t,id:e,content:l},r)},100),delete:o(function(t,e,l,r){let s=i("/docs/delete",d);n(s,"docs/delete",{gid:t,id:e,content:l},r)},100),list:o(function(t,e){let l=i("/docs/list",d),r="docs/list",s=p(t);n(l,r,s,e)},500)}))("https://groups.demo.pitoall.com"),w=(d=>({create:o(function(t,e){let l=i("/groups/create",d);n(l,"groups/create",t,e)},100),update:o(function(t,e,l){let r=i("/groups/update",d);n(r,"groups/update",{id:t,content:e},l)},100),taxCode:o(function(t,e){let l=i("https://api.vietqr.io/v2/business/"+t);g(l,r=>{r&&r.code=="00"?u(e,{result:!0,code:200,data:r.data}):u(e,{result:!1,code:400,message:""})})}),banks:o(function(t){let e=i("https://api.vietqr.io/v2/banks");g(e,l=>{l&&l.code=="00"?u(t,{result:!0,code:200,data:{data:l.data,total:l.data.length}}):u(t,{result:!1,code:400,message:""})})}),list:o(function(t,e){let l=i("/groups/list",d),r="groups/list",s=p(t);n(l,r,s,e)},500),docs:m}))("https://groups.demo.pitoall.com"),y=(d=>({address_update:function(t,e){let l=i("/address/update",d);n(l,"address/update",t,e)},address_list:o(function(t,e){let l=i("/address/list",d),r="address/list",s=p(t);n(l,r,s,e)},500),geo_address:o(function(t,e){let l=i("/address/geo_autocomplete",d);n(l,"address/geo_autocomplete",t,e)}),geo_detail:o(function(t,e){let l=i("/address/geo_detail",d);n(l,"address/geo_detail",t,e)})}))("https://groups.demo.pitoall.com");return{account:h,business:w,cates:y}}});})();

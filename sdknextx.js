...
(()=>{Object.defineProperty(window,"$http",{get:()=>{function S(r,t=10){let e=null;return(...l)=>{e===null&&(r(...l),e=setTimeout(()=>{e=null},t))}}function s(r,t=10){let e;return function(...l){clearTimeout(e),e=setTimeout(()=>{r(...l)},t)}}function a(r,t){return typeof r=="function"&&r(t)}function o(r,t){return new URL(r,t||document.baseURI).toString()}function n(r,t,e,l){if(!navigator.onLine)return a(l,{result:!1,code:400,message:"No internet connection"});fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:t,payLoad:e||{}})}).then(d=>{if(!d||!d.ok)throw new Error(d.statusText);return d.json()}).then(d=>{a(l,d)}).catch(d=>a(l,{result:!1,code:400,message:d.message||""}))}function g(r,t){if(!navigator.onLine)return a(t,{result:!1,code:400,message:"No internet connection"});fetch(r).then(e=>{if(!e.ok)throw new Error(e.statusText);return e.json()}).then(e=>{a(t,e)}).catch(e=>{a(t,{result:!1,code:400,message:e.message||""})})}function v(r){if(!r)return"";let t=r?.filterRules??[],e=r?.type??"and";if(e&&t.length>0){let u=t.map(c=>v(c)).filter(c=>c);return u.length>0?` ( ${u.join(` ${e} `)} ) `:""}let l=r?.field?.trim()??"",d=r?.op??"=",i=r?.value??"";return l?(i.startsWith("{{")&&i.endsWith("}}")?i=i.slice(2,-2):typeof i=="string"&&(i=i.trim(),i=`s'${i}'`),`${l} ${d} ${i}`):""}function p(r){if(!r)return"";let t=r?.id??"",e=r?.select??{},l=r?.where??{},d=r?.group??[],i=r?.order??{},u=r?.limit??100,c=r?.start??0,q=v(l),I="*";e&&(I=Object.keys(e).map(f=>`${e[f]} as ${f}`).join(","));let $=d.join(","),k=Object.keys(i).map(f=>`${f} ${i[f]}`).join(",");return{id:t,select:I,where:q,group:$,order:k,limit:u,start:c}}var h=(r=>({login:s(function(t,e,l){let d=o("/user/login",r);n(d,"users/login",{username:t,password:e},l)},500),generateQrcode:s(function(t,e){let l=o("/user/generate-qrcode",r);n(l,"users/generate-qrcode",t,e)},200),checkQrcode:s(function(t,e){let l=o("/user/check-qrcode",r);n(l,"users/check-qrcode",t,e)}),loginQrcode:s(function(t,e){let l=o("/user/login-qrcode",r);n(l,"users/login-qrcode",t,e)}),register:s(function(t,e){let l=o("/user/register",r);n(l,"users/register",t,e)},500),resendCode:s(function(t,e){let l=o("/user/resend-code",r);n(l,"users/resend-code",t,e)}),verifyCode:s(function(t,e){let l=o("/user/verify-code",r);n(l,"users/verify-code",t,e)}),forgotPassword:s(function(t,e){let l=o("/user/forgot-password",r);n(l,"users/forgot-password",t,e)}),setNewPassword:s(function(t,e){let l=o("/user/set-new-password",r);n(l,"users/set-new-password",t,e)}),profile:s(function(t){let e=o("/user/profile",r);n(e,"users/profile",{},t)}),updateProfile:s(function(t,e){let l=o("/user/update-profile",r);n(l,"users/update-profile",t,e)}),changePassword:s(function(t,e){let l=o("/user/change-password",r);n(l,"users/change-password",t,e)}),logout:s(function(t){let e=o("/user/logout",r);n(e,"users/logout",{},t)})}))("https://account.demo.pitoall.com"),m=(r=>({create:s(function(t,e,l,d){let i=o("/docs/create",r),u="docs/create";l={...l,gid:t,type:e},n(i,u,l,d)},100),update:s(function(t,e,l,d){let i=o("/docs/update",r);n(i,"docs/update",{gid:t,id:e,content:l},d)},100),delete:s(function(t,e,l,d){let i=o("/docs/delete",r);n(i,"docs/delete",{gid:t,id:e,content:l},d)},100),list:s(function(t,e,l){let d=o("/docs/list",r),i="docs/list",u=p(e);u.id=t,n(d,i,u,l)},500)}))("https://groups.demo.pitoall.com"),w=(r=>({create:s(function(t,e){let l=o("/groups/create",r);n(l,"groups/create",t,e)},100),update:s(function(t,e,l){let d=o("/groups/update",r);n(d,"groups/update",{id:t,content:e},l)},100),taxCode:s(function(t,e){let l=o("https://api.vietqr.io/v2/business/"+t);g(l,d=>{d&&d.code=="00"?a(e,{result:!0,code:200,data:d.data}):a(e,{result:!1,code:400,message:""})})}),banks:s(function(t){let e=o("https://api.vietqr.io/v2/banks");g(e,l=>{l&&l.code=="00"?a(t,{result:!0,code:200,data:{data:l.data,total:l.data.length}}):a(t,{result:!1,code:400,message:""})})}),list:s(function(t,e){let l=o("/groups/list",r),d="groups/list",i=p(t);n(l,d,i,e)},500),docs:m}))("https://groups.demo.pitoall.com"),y=(r=>({address_update:function(t,e){let l=o("/address/update",r);n(l,"address/update",t,e)},address_list:s(function(t,e){let l=o("/address/list",r),d="address/list",i=p(t);n(l,d,i,e)},500),geo_address:s(function(t,e){let l=o("/address/geo_autocomplete",r);n(l,"address/geo_autocomplete",t,e)}),geo_detail:s(function(t,e){let l=o("/address/geo_detail",r);n(l,"address/geo_detail",t,e)})}))("https://groups.demo.pitoall.com");return{account:h,business:w,cates:y}}});})();

...
(()=>{Object.defineProperty(window,"$http",{get:()=>{function $(t,r=10){let d=null;return(...o)=>{d===null&&(t(...o),d=setTimeout(()=>{d=null},r))}}function n(t,r=10){let d;return function(...o){clearTimeout(d),d=setTimeout(()=>{t(...o)},r)}}function a(t,r){return typeof t=="function"&&t(r)}function s(t,r){return new URL(t,r||document.baseURI).toString()}function u(t,r,d,o){if(!navigator.onLine)return a(o,{result:!1,code:400,message:"No internet connection"});fetch(t,{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:r,payLoad:d||{}})}).then(e=>{if(!e||!e.ok)throw new Error(e.statusText);return e.json()}).then(e=>{a(o,e)}).catch(e=>a(o,{result:!1,code:400,message:e.message||""}))}function p(t,r){if(!navigator.onLine)return a(r,{result:!1,code:400,message:"No internet connection"});fetch(t).then(d=>{if(!d.ok)throw new Error(d.statusText);return d.json()}).then(d=>{a(r,d)}).catch(d=>{a(r,{result:!1,code:400,message:d.message||""})})}function g(t){if(!t)return"";let r=t?.filterRules??[],d=t?.type??"and";if(d&&r.length>0){let i=r.map(c=>g(c)).filter(c=>c);return i.length>0?` ( ${i.join(` ${d} `)} ) `:""}let o=t?.field?.trim()??"",e=t?.op??"=",l=t?.value??"";return o?(l.startsWith("{{")&&l.endsWith("}}")?l=l.slice(2,-2):typeof l=="string"&&(l=l.trim(),l=`s'${l}'`),`${o} ${e} ${l}`):""}function v(t){if(!t)return"";let r=t?.id??"",d=t?.select??{},o=t?.where??{},e=t?.group??[],l=t?.order??{},i=t?.limit??100,c=t?.start??0,q=g(o),I="*";d&&(I=Object.keys(d).map(f=>`${d[f]} as ${f}`).join(","));let y=e.join(","),_=Object.keys(l).map(f=>`${f} ${l[f]}`).join(",");return{id:r,select:I,where:q,group:y,order:_,limit:i,start:c}}var h=(t=>{var r=!1,d="";let o=null;return window.addEventListener("deviceId",function(e){e.detail&&(o=e.detail)}),typeof TflInvoker<"u"&&TflInvoker.postMessage("deviceId"),{keepOnline:n(function(e){let l=s("/user/keep-online",t);u(l,"",{},e)},500),checkAuth:n(function(e){let l=s("/user/check-token-live",t);u(l,"",{},e)},500),login:n(function(e,l){let i=s("/user/login",t);u(i,"users/login",e,l)},500),generateQrcode:n(function(e){let l=s("/user/generate-qrcode",t);u(l,"users/qrcode/generate-qrcode",{},c=>{c.code=="200"&&(r=!0,d=c.data.zid),typeof e=="function"&&e(c)})},200),checkQrcode:n(function(e,l){let i=s("/user/check-qrcode",t);u(i,"users/qrcode/check-qrcode",e,l)}),loginQrcode:n(function(e,l){let i=s("/user/login-qrcode",t);u(i,"users/qrcode/login-qrcode",e,l)}),checkScanQrCode:n(function(e,l){let i=s("/user/check-qrcode-token",t);u(i,"users/qrcode/check-qrcode-token",e,l)}),register:n(function(e,l){let i=s("/user/register",t);u(i,"users/register",e,l)},500),resendCode:n(function(e,l){let i=s("/user/resend-code",t);u(i,"users/resend-code",e,l)}),verifyCode:n(function(e,l){let i=s("/user/register-verify-code",t);u(i,"users/register-verify-code",e,l)}),forgotPasswordRequest:n(function(e,l){let i=s("/user/forgot-password",t);u(i,"users/forgot-password",e,l)}),forgotPasswordCheckCode:n(function(e,l){let i=s("/user/forgot-password-check-code",t);u(i,"users/forgot-password-check-code",e,l)}),forgotPasswordSetNewPassword:n(function(e,l){let i=s("/user/forgot-password-reset",t);u(i,"users/forgot-password-reset",e,l)}),profile:n(function(e){let l=s("/user/profile",t);u(l,"users/profile",{},e)}),updateProfile:n(function(e,l){let i=s("/user/update-profile",t);u(i,"users/update-profile",e,l)}),changePassword:n(function(e,l){let i=s("/user/change-password",t);u(i,"users/change-password",e,l)}),logout:n(function(e){let l=s("/user/logout",t);u(l,"users/logout",{},e)})}})("https://account.demo.pitoall.com"),m=(t=>({create:n(function(r,d,o,e){let l=s("/docs/create",t),i="docs/create";o={...o,gid:r,type:d},u(l,i,o,e)},100),update:n(function(r,d,o,e){let l=s("/docs/update",t);u(l,"docs/update",{gid:r,id:d,content:o},e)},100),delete:n(function(r,d,o,e){let l=s("/docs/delete",t);u(l,"docs/delete",{gid:r,id:d,content:o},e)},100),list:n(function(r,d,o){let e=s("/docs/list",t),l="docs/list",i=v(d);i.id=r,u(e,l,i,o)},500)}))("https://groups.demo.pitoall.com"),w=(t=>({create:n(function(r,d){let o=s("/groups/create",t);u(o,"groups/create",r,d)},100),update:n(function(r,d,o){let e=s("/groups/update",t);u(e,"groups/update",{id:r,content:d},o)},100),taxCode:n(function(r,d){let o=s("https://api.vietqr.io/v2/business/"+r);p(o,e=>{e&&e.code=="00"?a(d,{result:!0,code:200,data:e.data}):a(d,{result:!1,code:400,message:""})})}),banks:n(function(r){let d=s("https://api.vietqr.io/v2/banks");p(d,o=>{o&&o.code=="00"?a(r,{result:!0,code:200,data:{data:o.data,total:o.data.length}}):a(r,{result:!1,code:400,message:""})})}),list:n(function(r,d){let o=s("/groups/list",t),e="groups/list",l=v(r);u(o,e,l,d)},500),docs:m}))("https://groups.demo.pitoall.com"),k=(t=>({address_update:function(r,d){let o=s("/address/update",t);u(o,"address/update",r,d)},address_list:n(function(r,d){let o=s("/address/list",t),e="address/list",l=v(r);u(o,e,l,d)},500),geo_address:n(function(r,d){let o=s("/address/geo_autocomplete",t);u(o,"address/geo_autocomplete",r,d)}),geo_detail:n(function(r,d){let o=s("/address/geo_detail",t);u(o,"address/geo_detail",r,d)})}))("https://groups.demo.pitoall.com");return{account:h,business:w,cates:k}}});})();
